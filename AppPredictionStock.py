...
from prophet import Prophet # prophet not fbprophet
...
# FORECAST
    ...
    df_train['ds'] = df_train['ds'].apply(lambda x: x.strftime('%Y-%m-%d %H:%M:%S')) # Remove timezone from dataframe column with datetime format
